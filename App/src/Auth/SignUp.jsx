        ...
        try {
            ...
            const response = await fetch('http://localhost:3000/signup', {
                ...
                body: JSON.stringify({
                    ...
                    password: password,
                    name: name // Include name if your backend supports it
                }),
            });
            ...
            <div className="max-w-md w-full space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Join TaskMaster to organize your tasks and projects
                    </p>
                </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <button
                                ...
                                className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-500 dark:hover:bg-blue-600 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                            >
                                {isSubmitting ? (
                                    <>
